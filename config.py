...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://sahilkaleech:6W9ZsFlnDAUs0npJ@cluster0.sp70f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluster0")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002197951128"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "2099486124").split()):
        ADMINS.append(int(x))
except ValueError:
